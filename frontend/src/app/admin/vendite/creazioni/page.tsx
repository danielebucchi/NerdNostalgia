...
export default function VenditeCreazioniPage() {
  ...
  return (
    <AdminShell>
      <VenditeNav active="creazioni" />

      <div className="flex items-center justify-between mb-4 gap-3 flex-wrap">
        <p className="text-ink-soft text-sm">
          Vendite di creazioni handmade. I costi bulk extra vanno in
          Spese → Altre con flag <em>creazioni</em>, e vengono sottratti
          dal profitto netto in dashboard.
        </p>
      ...
      <SalesTable kind="creation" year={year} platformNames={platformNames} />
