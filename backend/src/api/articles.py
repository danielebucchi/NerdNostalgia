...
def _to_response(article: Article) -> ArticleResponse:
    ...
    return ArticleResponse(
        ...
        card_condition=article.card_condition,
        card_language=article.card_language,
        card_reverse=bool(article.card_reverse),
        card_first_edition=bool(article.card_first_edition),
        ...
        cardtrader_blueprint_id=article.cardtrader_blueprint_id,
        cardtrader_product_id=article.cardtrader_product_id,
        cardtrader_synced_at=article.cardtrader_synced_at.isoformat() if article.cardtrader_synced_at else None,
...
def create_article(
    ...
    new_article = Article(
        ...
        card_condition=article_data.card_condition,
        card_language=article_data.card_language,
        card_reverse=bool(article_data.card_reverse),
        card_first_edition=bool(article_data.card_first_edition),
